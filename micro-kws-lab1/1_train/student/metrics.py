...
def recall(
    ...
    correct_trials = matrix[idx][idx]
    total_trials = tf.reduce_sum(matrix, 1)[idx]

    recall = correct_trials / total_trials;
...
def precision(
    ...
    ### ENTER STUDENT CODE BELOW ###
    correct_trials = matrix[idx][idx]
    total_trials = tf.reduce_sum(matrix, 0)[idx]

    precision = correct_trials / total_trials;
    ### ENTER STUDENT CODE ABOVE ###
